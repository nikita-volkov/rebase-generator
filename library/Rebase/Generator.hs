...
modules =
  [
    ...
    forw "GHC.Conc",
    forw "GHC.Conc.IO",
    forw "GHC.Conc.Signal",
    forw "GHC.Conc.Sync",
    forw "GHC.ConsoleHandler",
    forw "GHC.Constants",
    forw "GHC.Desugar",
    forw "GHC.Enum",
    forw "GHC.Environment",
    forw "GHC.Err",
    forw "GHC.Exception",
    forw "GHC.Exts",
    forw "GHC.Fingerprint",
    forw "GHC.Fingerprint.Type",
    forw "GHC.Float",
    forw "GHC.Float.ConversionUtils",
    forw "GHC.Float.RealFracMethods",
    forw "GHC.Foreign",
    forw "GHC.ForeignPtr",
    forw "GHC.Generics",
    forw "GHC.GHCi",
    ...
    forw "GHC.IO",
    forw "GHC.IO.Buffer",
    forw "GHC.IO.BufferedIO",
    forw "GHC.IO.Device",
    forw "GHC.IO.Encoding",
    forw "GHC.IO.Encoding.CodePage",
    forw "GHC.IO.Encoding.Failure",
    forw "GHC.IO.Encoding.Iconv",
    forw "GHC.IO.Encoding.Latin1",
    forw "GHC.IO.Encoding.Types",
    forw "GHC.IO.Encoding.UTF16",
    forw "GHC.IO.Encoding.UTF32",
    forw "GHC.IO.Encoding.UTF8",
    forw "GHC.IO.Exception",
    forw "GHC.IO.FD",
    forw "GHC.IO.Handle",
    forw "GHC.IO.Handle.FD",
    forw "GHC.IO.Handle.Internals",
    forw "GHC.IO.Handle.Text",
    forw "GHC.IO.Handle.Types",
    forw "GHC.IO.IOMode",
    forw "GHC.IOArray",
    forw "GHC.IORef",
    forw "GHC.List",
